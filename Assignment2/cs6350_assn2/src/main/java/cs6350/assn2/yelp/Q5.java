...
public class Q5 {
	...
	public static class Q5Mapper extends Mapper<LongWritable, Text, Text, SumCount> {
	...
	public static class Q5Combiner extends Reducer<Text, SumCount, Text, SumCount> {
	...
	public static class Q5Reducer extends Reducer<Text, SumCount, Text, DoubleWritable> {
